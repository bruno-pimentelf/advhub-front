...
export default function ApplicationFormWrapper() {
  ...
  return (
    <>
      <section id="application-form" className="py-16 sm:py-24 md:py-32 bg-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <BlurFade direction="up" delay={0.4}>
              <div className="bg-gradient-to-r from-[#04CDD4]/5 to-[#03a8a8]/5 rounded-2xl p-6 sm:p-8 border border-[#04CDD4]/20 mb-6 sm:mb-8">
            ...
            <BlurFade direction="up" delay={0.6}>
              <button
                onClick={openForm}
                className="bg-gradient-to-r from-[#04CDD4] to-[#03a8a8] hover:from-[#03a8a8] hover:to-[#04CDD4] text-white font-semibold py-4 sm:py-6 px-8 sm:px-12 text-base sm:text-lg rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                INICIAR APLICAÇÃO
              </button>
            </BlurFade>
